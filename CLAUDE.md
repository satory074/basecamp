...
- Monthly audit: `.github/workflows/monthly-secret-audit.yml` — cron `0 0 1 * *` + `workflow_dispatch`, scans **basecamp + odekaketenki + uranai + Annasui** via gitleaks against full git history. Findings ping Discord.
