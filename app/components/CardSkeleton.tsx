...
export default function CardSkeleton({ variant = 'post', className = '' }: CardSkeletonProps) {
            ...
            <div className={`glass-card-enhanced service-card card-padding-mobile p-8 animate-pulse ${className}`}>
                <div className="flex justify-between items-start mb-8">
                    <div className="flex items-center">
                        <div className="relative p-4 bg-gray-200 dark:bg-gray-700 rounded-2xl mr-4 w-16 h-16" />
                        <div>
    ...
    if (variant === 'stats') {
        return (
            <div className={`text-center p-8 rounded-2xl bg-gray-100 dark:bg-gray-800 animate-pulse ${className}`}>
    ...
    return (
        <div className={`bg-white dark:bg-gray-800 border rounded-lg overflow-hidden shadow-sm h-[120px] md:h-[100px] animate-pulse ${className}`}>
