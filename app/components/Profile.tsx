        ...
        <div>
            <div className="relative w-32 h-32 mb-4">
                {!imageError ? (
                    ...
                    <div className="w-32 h-32 rounded-full bg-gradient-to-br from-indigo-100 to-purple-100 dark:from-indigo-900 dark:to-purple-900 flex items-center justify-center">
